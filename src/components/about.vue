      ...
      <div class="flex">
        ...
        <div class="w-1/2 pl-12">
          <div class="composition">
            ...
            <img src="../assets/coding.jpeg" alt="Photo 2" class="composition__photo composition__photo--p2">

            <img src="../assets/gadget4.jpeg" alt="Photo 3" class="composition__photo composition__photo--p3">
          </div>
        </div>
      </div>
    </section>
