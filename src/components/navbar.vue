<template>
  <div>
    <div class="px-6 py-6 lg:px-8 sticky top-0">
    <div>
      <nav class="flex h-9 items-center justify-between text-red-600" aria-label="Global">
        <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
          <a href="#" class="m-1.5 p1.5">
        ...
        <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
          <a href="#" class="font-semibold text-red-600 hover:text-red-900 cursor-pointer">Product</a>

          <a href="#" class="font-semibold text-red-600 hover:text-red-900">Features</a>

          <a href="#" class="font-semibold text-red-600 hover:text-red-900">Marketplace</a>

          <a href="#" class="font-semibold text-red-600 hover:text-red-900">Company</a>
        </div>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                <a href="#" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10 cursor-pointer">Home</a>
                ...
                <a href="#" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Explore</a>
              </div>
              <div class="py-6">
